...
@Component({
  selector: 'app-xbet-retrait',
  templateUrl: './xbet-retrait.component.html',
  styleUrls: ['./xbet-retrait.component.css']
})
export class XbetRetraitComponent implements OnInit {
